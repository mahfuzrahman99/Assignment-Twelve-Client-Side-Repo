import contactBanner from "../../assets/cotactBanner.jpg"
...
const ContactUs = () => {
  return (
    <>
      <Helmet>
        <title>CareCampusPro | Contact</title>
      </Helmet>
      <div>
        <div>
          <img className="w-full h-[40vh] md:h-[80vh]" src={contactBanner} alt="" />
        </div>
          ...
          <div className="my-8 md:mb-56">
            <div>
              <div className=" rounded-lg p-2 md:px-20 md:pt-20 md:pb-12 bg-[#F3F3F3]">
                <form className="md:grid grid-cols-2 gap-3  font-inter">
                ...
                <div>
                  <div className="flex justify-center mt-16">
                    <div className="flex justify-center gap-1 p-3 rounded-lg items-center bg-gradient-to-r from-[#47b2f1] to-[#4c7b96]">
