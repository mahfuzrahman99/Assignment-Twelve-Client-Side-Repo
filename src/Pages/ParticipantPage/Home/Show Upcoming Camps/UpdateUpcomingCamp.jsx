...
const UpdateUpcomingCamp = ({ showModal, setShowModal, camp }) => {
  const {
    handleSubmit,
    register,
    reset,
    ...
    <>
      {showModal && (
        <dialog id="my_modal_1" className="modal" open>
          <div className="modal-box w-[300px] md:w-auto max-h-[90vh] max-w-4xl mx-auto">
            <>
              <Helmet>
...
export default UpdateUpcomingCamp;
