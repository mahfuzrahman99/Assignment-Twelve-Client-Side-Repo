...
const UpdateParticipantProfile = ({ showModal,user, setShowModal }) => {
  ...
  const handleProfileUpdate = (e) => {
    ...
    axiosSecure.patch(`/users/participant/${user1._id}`, profileInfo).then((responses) => {
            ...
            >
              <div className="w-full p-4">
                ...
                <div className="flex justify-center my-3">
                  <input type="submit" className="btn md:w-1/4 w-3/4" value="Update" />
                </div>
              </div>
            </form>
