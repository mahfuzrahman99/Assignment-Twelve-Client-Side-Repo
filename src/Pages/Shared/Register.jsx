import registerImg from "../../assets/Slider-Doctor/Ragistration-Page-Image.png";
import REGISTATIONPAGEBG from "../../assets/Slider-Doctor/RagistrationBgImg.jpg";
        ...
        <div className="flex justify-center  items-center  lg:p-12 ">
          <div className="md:grid grid-cols-2 justify-center items-center gap-8 border-b-4 border-r-4 border-[#00000040] shadow-xl md:mx-28">
            <div className="">
              ...
              >
                ...
                <div className="form-control mt-3">
                  <button className="btn bg-[#427897] uppercase hover:text-black hover:bg-[#427897] rounded-md text-white ">
                    Register
                  </button>
                </div>
                <div>
            ...
            <div className="col-span-1">
              <img
                src={registerImg}
                className=" md:mr-7 h-[350px] w-[550px]"
                alt=""
              />
            </div>
          </div>
