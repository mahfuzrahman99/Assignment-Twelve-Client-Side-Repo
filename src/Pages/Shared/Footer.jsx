...
const Footer = () => {
    return (
      <div className="md:grid grid-cols-2 font-inter text-white">
        <div className="col-span-1 md:grid grid-cols-2  bg-[#1F2937]  text-center p-6">
        ...
        <div className="col-span-1 md:grid grid-cols-2 bg-[#111827] text-center p-6">
        ...
        <div className="col-span-2 text-center bg-black p-3 font-medium font-inter">
          <h1>Copyright © All rights reserved. by CareCampusPro</h1>
        </div>
      </div>
    );
  };
